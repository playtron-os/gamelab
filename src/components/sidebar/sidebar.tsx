...
export const Sidebar: React.FC = () => {
  ...
  return (
    <>
      <div className="relative w-72 px-4 py-2 border-r-2 border-gray-800 h-screen overflow-scroll">
        ...
        <footer className="fixed bottom-0 left-0 mr-4 p-1 w-72 overflow-hidden bg-black">
          <Divider type="subtle" />
          <ProfileMenu />
        </footer>
      </div>
